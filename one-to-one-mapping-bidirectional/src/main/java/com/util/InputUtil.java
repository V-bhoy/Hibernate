...
public class InputUtil {
    ...
    public static int menuOptions(Scanner sc){
        ...
        System.out.println("5. Fetch Adhaar Details By Person Id");
        System.out.println("6. Fetch Details By Adhaar Id");
        if(sc.hasNextInt()) {
    ...
    public static int acceptAdhaarId(Scanner sc){
        int adhaarId;
        while (true){
            ...
            if(sc.hasNextInt()){
                ...
                sc.nextLine();
                if(adhaarId <= 0){
                    System.out.println("Adhaar Id is not valid!");
                }else{
                    break;
                }
            }else{
                sc.next();
                System.out.println("Invalid adhaar Id!");
            }
        }
        return adhaarId;
    }
